...
Gem::Specification.new do |s|
  ...
  s.files = [".standard.yml".freeze, "Code-of-Conduct.md".freeze, "Contributing.md".freeze, "History.md".freeze, "Licence.md".freeze, "Manifest.txt".freeze, "README.md".freeze, "Rakefile".freeze, "data/content_type_mime.db".freeze, "data/ext_mime.db".freeze, "data/mime-types.json".freeze, "data/mime.content_type.column".freeze, "data/mime.docs.column".freeze, "data/mime.encoding.column".freeze, "data/mime.flags.column".freeze, "data/mime.friendly.column".freeze, "data/mime.pext.column".freeze, "data/mime.use_instead.column".freeze, "data/mime.xrefs.column".freeze, "lib/mime-types-data.rb".freeze, "lib/mime/types/data.rb".freeze, "types/application.yaml".freeze, "types/audio.yaml".freeze, "types/chemical.yaml".freeze, "types/conference.yaml".freeze, "types/drawing.yaml".freeze, "types/font.yaml".freeze, "types/image.yaml".freeze, "types/message.yaml".freeze, "types/model.yaml".freeze, "types/multipart.yaml".freeze, "types/text.yaml".freeze, "types/video.yaml".freeze, "types/world.yaml".freeze]
